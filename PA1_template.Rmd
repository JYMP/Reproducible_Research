...
```{r, echo=TRUE}
qplot(interval, average, data = int) + xlab("5-minute intervals") + 
...
Mean number of steps per day is `r mean_steps.filled`
Median number of steps per day is `r median_steps.filled`
